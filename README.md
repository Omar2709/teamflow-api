...
The project currently contains **180 passing automated tests** covering authentication, authorization, teams, projects, tasks, comments, dashboards, notifications, database behavior, and Celery integration.
...
The project currently contains **180 passing automated tests** covering business rules, permissions, database behavior, API endpoints, dashboards, notifications, and Celery integration.
